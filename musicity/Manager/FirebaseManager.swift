...
struct FirebaseManager {
    ...
    //we use this for logout the user
    ...
    func getTheUserIdMessengerToDdb(_ userId : String, completion : @escaping(Result<[String],FirebaseError>) -> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.messengerUserId.returnAccessPath).observeSingleEvent(of: .value) { snapshot in
    ...
    func setTheUserIdMessengerInDdb(_ userId : String, _ userIdMessenger : [String:Any] , completion : @escaping(Result<Void, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.messengerUserId.returnAccessPath).setValue(userIdMessenger) { errorInfo, _ in
    ...
    func setNewMessage(_ userId : String, _ resultUserId : String, _ message : [String:Any], completion : @escaping(Result<Void, FirebaseError>) -> Void) {
        observeKeyMessenger(userId, resultUserId) { result in
            ...
            case .success(let key):
                appDelegate.ref!.child(DataBaseAccessPath.messages.returnAccessPath).child(key).childByAutoId().setValue(message) { errorInfo, _ in
                    guard errorInfo == nil else {
                        completion(.failure(.connexionError))
                        return
                    }
    ...
    private func observeKeyMessenger(_ userId : String,_ resultUserId : String, completion : @escaping(Result<String,FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.messages.returnAccessPath).observeSingleEvent(of: .value, with: { (snapshot) in
    ...
    func readInMessengerDataBase(_ userId : String,_ resultUserId : String, completion : @escaping(Result<[String : Any], FirebaseError>) -> Void) {
        observeKeyMessenger(userId, resultUserId) { result in
            switch result {
            case .success(let key):
                appDelegate.ref!.child(DataBaseAccessPath.messages.returnAccessPath).child(key).observe(.childAdded, with: { (snapshot) -> Void in
    ...
    func checkNotificationBanner(_ userId : String, completion : @escaping(Result<[String : Any], FirebaseError>) -> Void ) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notificationBanner.returnAccessPath).observe(.childAdded, with: { (snapshot) -> Void in
            if let value = snapshot.value as?[String : Any] {
                completion(.success(value))
            } else {
                completion(.failure(.InfoError))
    ...
    func removeNotificationBanner(_ userId : String) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notificationBanner.returnAccessPath).removeValue()
    }
    ...
    func setNotificationBanner(_ userId : String,_ otherUserId : String, _ infoUser : [String : Any],  completion : @escaping(Result<Void, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notificationBanner.returnAccessPath).childByAutoId().setValue(infoUser) { errorInfo, _ in
            guard errorInfo == nil else {
                completion(.failure(.connexionError))
                return
            }
    ...
    func removeNotificationObserver(_ userId : String) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notificationBanner.returnAccessPath).removeAllObservers()
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notification.returnAccessPath).removeAllObservers()
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.messengerUserId.returnAccessPath).removeAllObservers()
    }
    ...
    func setNewUserNotification(_ userId : String, _ otherUserId : String,  completion : @escaping(Result<Void, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notification.returnAccessPath).child(otherUserId).setValue([DataBaseAccessPath.notification.returnAccessPath:otherUserId]) { errorInfo, _ in
            guard errorInfo == nil else {
                completion(.failure(.connexionError))
                return
            }
    ...
    func checkNewUserNotification(_ userId : String,  completion : @escaping(Result<[String:Any], FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notification.returnAccessPath).observe(.childAdded, with: { (snapshot) -> Void in
            if let value = snapshot.value as?[String : Any] {
                completion(.success(value))
            } else {
                completion(.failure(.InfoError))
    ...
    func removeNotificationUser(_ userId : String, _ otherUserId : String) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child(DataBaseAccessPath.notification.returnAccessPath).child(otherUserId).removeValue()
    }
    
    //remove the observ for have a new notification
    ...
    func getAllTheInfoToFirebase(_ userId : String, completion : @escaping(Result<[String : Any], FirebaseError>) -> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).observe(.value) { snapshot in
            if let value = snapshot.value as?[String : Any] {
                completion(.success(value))
            } else {
                completion(.failure(.InfoError))
    ...
    func getDictionnaryInfoUserToFirebase(_ userId : String, _ infoProfil : DataBaseAccessPath, completion : @escaping(Result<[String : Any], FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child("\(infoProfil.returnAccessPath)").observeSingleEvent(of: .value) { snapshot in
            if let value = snapshot.value as? [String : Any] {
                completion(.success(value))
            } else {
                completion(.failure(.InfoError))
    ...
    func setDictionnaryUserInfo(_ userId : String, _ infoUser : [String : Any], _ infoProfil : DataBaseAccessPath, completion : @escaping(Result<Void, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child("\(infoProfil.returnAccessPath)").setValue(infoUser) { errorInfo, _ in
            guard errorInfo == nil else {
                completion(.failure(.connexionError))
                return
            }
    ...
    func setSingleUserInfo(_ userId : String,_ firstChild : DataBaseAccessPath, _ secondChild : DataBaseAccessPath, _ infoUser: String, completion : @escaping(Result<Void, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child("\(firstChild.returnAccessPath)").child(secondChild.returnAccessPath).setValue(infoUser)
        completion(.success(()))
    }
    ...
    func getSingleInfoUserToFirebase(_ userId : String, _ firstChild : DataBaseAccessPath,_ secondChild : DataBaseAccessPath, completion : @escaping(Result<String, FirebaseError>)-> Void) {
        appDelegate.ref!.child(DataBaseAccessPath.users.returnAccessPath).child(userId).child("\(firstChild.returnAccessPath)").child(secondChild.returnAccessPath).observeSingleEvent(of: .value) { snapshot in
            if let value = snapshot.value as? String {
                completion(.success(value))
            } else {
                completion(.failure(.InfoError))
    ...
    func setImageInFirebaseAndGetUrl( _ userId : String, _ imageData : Data, completion : @escaping(Result<String, FirebaseError>) -> Void ) {
        storage.child(userId).child(DataBaseAccessPath.profilImage.returnAccessPath).putData(imageData, metadata: nil, completion: { _, error in
    ...
    func getUrlImageToFirebase( _ userId : String, completion : @escaping(Result<String, FirebaseError>) -> Void) {
        storage.child(userId).child(DataBaseAccessPath.profilImage.returnAccessPath).downloadURL { url, error in
